<div align="center">
  ...
  <p>Construyendo sistemas robustos con <b>PHP / Laravel</b> y orquestando infraestructuras con <b>Docker</b></p>
</div>
...
[cite_start]Desarrollo integral de un motor de comercio electrónico utilizando **PHP** y **Laravel**[cite: 1, 3]. [cite_start]Enfoque en arquitectura limpia y gestión eficiente de la persistencia[cite: 1, 3].

**Resource Optimization Engine (Schedule Automator)**
[cite_start]Desarrollo de un algoritmo en **Vanilla Javascript** para la generación automatizada de horarios laborales[cite: 1, 3]. 
* [cite_start]**Lógica:** Resolución de restricciones complejas como cuotas horarias y descansos legales[cite: 1, 3].
* [cite_start]**Integración:** Gestión de datos mediante la API de Google Sheets como base de datos ligera[cite: 1, 3].

**Docker Infrastructure Deployment**
[cite_start]Implementación de infraestructura escalable mediante contenedores[cite: 1, 3]. [cite_start]Configuración de **Nginx** como proxy inverso y gestión de bases de datos MariaDB para entornos LEMP[cite: 1, 3].
